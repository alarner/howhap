...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var a=e[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,r,a){return r&&t(e.prototype,r),a&&t(e,a),e}}(),Hogan=require("hogan.js"),message=null,status=null,params=null,template=null,Howhap=function(){function t(e,r){if(_classCallCheck(this,t),"[object Object]"!==Object.prototype.toString.call(e))throw new Error("First argument to Howhap constructor must be an object.");if(!e.hasOwnProperty("message"))throw new Error("First argument to Howhap constructor must contain a message property.");if(!e.hasOwnProperty("status"))throw new Error("First argument to Howhap constructor must contain a status property.");void 0!==r&&null!==r||(r=e.hasOwnProperty("params")?e.params:{}),this.message=e.message,this.status=e.status,this.params=r}return _createClass(t,[{key:"toString",value:function(){return template.render(params)}},{key:"toJSON",value:function(){var t={};for(var e in params)t[e]=""+params[e];return{message:message,status:status,params:t}}},{key:"set",value:function(t){t.hasOwnProperty("message")&&(this.message=t.message),t.hasOwnProperty("status")&&(this.status=t.status),t.hasOwnProperty("params")&&(this.params=t.params)}},{key:"message",get:function(){return message},set:function(t){if("string"!=typeof t&&!(t instanceof String))throw new Error("Message property must be a string.");message=t,template=Hogan.compile(message)}},{key:"status",get:function(){return status},set:function(t){var e=parseInt(t);if(e!=t||isNaN(e))throw new Error("Status property must be an integer.");status=e}},{key:"params",get:function(){return params},set:function(t){if(void 0!==t&&null!==t||(t={}),"[object Object]"!==Object.prototype.toString.call(t))throw new Error("Params property must be an object.");params=t}}]),t}();Howhap.prototype.prototype=new Error,module.exports=Howhap;
},{"hogan.js":2}]},{},[4])


//# sourceMappingURL=./dist/index.min.map