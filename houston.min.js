...
"use strict";var Hogan=require("hogan.js");module.exports=function(t,s){if("[object Object]"!==Object.prototype.toString.call(t))throw"First argument to Houston constructor must be an object.";if(!t.hasOwnProperty("message"))throw"First argument to Houston constructor must contain a message property.";if(!t.hasOwnProperty("status"))throw"First argument to Houston constructor must contain a status property.";var r=t.message,e=parseInt(t.status);if((void 0===s||null===s)&&(s=t.hasOwnProperty("params")?t.params:{}),"string"!=typeof r&&!(r instanceof String))throw"Message property must be a string.";if(e!==t.status)throw"Status property must be an integer.";if("[object Object]"!==Object.prototype.toString.call(s))throw"Params must be an object.";var o=Hogan.compile(r);this.toString=function(){return o.render(s)},this.toJSON=function(){return{message:r,status:e,params:s}},this.set=function(t){t.hasOwnProperty("message")&&(r=t.message,o=Hogan.compile(r)),t.hasOwnProperty("status")&&(e=t.status),t.hasOwnProperty("params")&&(s=t.params)},this.message=function(){return r},this.status=function(){return e},this.params=function(){return s}};
},{"hogan.js":3}],2:[function(require,module,exports){
...
//# sourceMappingURL=houston.min.map