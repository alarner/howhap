...
"use strict";var Hogan=require("hogan.js");module.exports=function(s,t,a){var e=Hogan.compile(s);this.display=function(){return e.render(a)},this.toJSON=function(){return{message:s,status:t,params:a}},this.set=function(r){r.hasOwnProperty("message")&&(s=r.message,e=Hogan.compile(s)),r.hasOwnProperty("status")&&(t=r.status),r.hasOwnProperty("params")&&(a=r.params)}};
